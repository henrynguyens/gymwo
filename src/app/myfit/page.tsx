                ...
                {isAnalyzing ? (
                    <div className={styles.dashboardGrid}>
                        ...
                        <div className={styles.column}>
                            <div className={styles.card} style={{ height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f5f5f7' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', color: '#8E8E93' }}>
                                    <RefreshCw className="animate-spin" size={32} />
                                    <span>Calculating Macros...</span>
                                </div>
                            </div>
                            <div className={styles.card} style={{ height: '400px', backgroundColor: '#f5f5f7' }}></div>
                        </div>
                        {/* Skeleton Right Column */}
                        <div className={styles.column}>
                            <div className={styles.row} style={{ height: '50px', marginBottom: '1rem', display: 'flex', gap: '0.5rem' }}>
                                {[...Array(5)].map((_, i) => (
                                    <div key={i} style={{ flex: 1, backgroundColor: '#f5f5f7', borderRadius: '20px' }}></div>
                                ))}
                            </div>
                            <div className={styles.card} style={{ height: '500px', backgroundColor: '#f5f5f7' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: '1rem', color: '#8E8E93' }}>
                                    <RefreshCw className="animate-spin" size={32} />
                                    <span>Generating Workout Plan...</span>
                                </div>
                            </div>
                        </div>
                    </div>
